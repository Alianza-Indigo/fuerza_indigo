...
| F4-CRE-001 | Implementar la emisión de credenciales con código opaco firmado y diseños diferenciados | Hecho. Código opaco firmado con llavero rotable y cinco diseños diferenciados por etiqueta, franja y símbolo (ADR-0090, ADR-0093). Las de agremiado y honoraria nacen con la membresía; la de beneficiario nace con el registro protegido; las de cargo y profesionales se emiten con motivo escrito |
