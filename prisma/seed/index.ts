    ...
    data: {
      ...
      rules: {
        ...
        _pendientesDeEstatutos: [
          ...
          'electionCallNoticeDays: anticipación mínima de la convocatoria a elecciones (PRD §9.6 remite al calendario electoral estatutario)',
          'genderProportionalityMinPercent: porcentaje mínimo de cada género en una planilla (PRD §9.6: «control de proporcionalidad de género»)',
          'disciplinaryAnswerDays: días para contestar y ofrecer pruebas (PRD §9.8 remite al procedimiento estatutario)',
          'disciplinaryAppealDays: días para recurrir una resolución disciplinaria (ídem)',
          'bargainingConsultationMajority: mayoría con la que se aprueba una consulta de contrato colectivo (PRD §9.7)',
        ],
      },
      createdByActorId: actorId,
      updatedByActorId: actorId,
