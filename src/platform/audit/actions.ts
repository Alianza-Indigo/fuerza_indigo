...
export const AUDIT_ACTIONS = {
  ...
  CASE_EMERGENCY_RAISED: 'cases.emergency.raised',
  CASE_EMERGENCY_ACKNOWLEDGED: 'cases.emergency.acknowledged',
  CASE_EMERGENCY_CLOSED: 'cases.emergency.closed',
  CASE_REFERRAL_PROPOSED: 'cases.referral.proposed',
  CASE_REFERRAL_CONSENT_REQUESTED: 'cases.referral.consent_requested',
  CASE_REFERRAL_SENT: 'cases.referral.sent',
  CASE_REFERRAL_ACCEPTED: 'cases.referral.accepted',
  CASE_REFERRAL_RETURNED: 'cases.referral.returned',
  CASE_REFERRAL_CLOSED: 'cases.referral.closed',
  CASE_DOCUMENT_ADDED: 'cases.document.added',
  CASE_DOCUMENT_REMOVED: 'cases.document.removed',
